using CleanArchitectureDemoProject.BoundedContext.SqlContext;
using CleanArchitectureDemoProject.Models.Enums.Main;
...
namespace CleanArchitectureDemoProject.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(CleanArchitectureDemoProject.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(CleanArchitectureDemoProject.Models.Main.LanguageContent.ComponentLanguageContents))]
